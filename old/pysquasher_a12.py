...
def parse_header(hdr):
    ...
    flagged_dipoles = np.frombuffer(hdr[80:152], dtype=np.uint64)
    ...
    return (magic, t0, t1, flagged_dipoles)
...
if __name__ == "__main__":
    ...
    for f in config.files:
        ...
        f.seek(start)
        m, t0, _, _ = parse_header(f.read(LEN_HDR))
    ...
    for f in files:
        ...
        for i in range(N):
            ...
            m, t0, t1, fl = parse_header(f.read(LEN_HDR))
            flagged = []
